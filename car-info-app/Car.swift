...
//    
//    var fuelEfficiecyString: String { get }
...
//
//protocol Electric {
//    var electricEfficiecy: Double { get set }
//    var fullCargeHours: Double { get set }
//    var autoLevel: Int { get set }
//    
//    var elecrticEfficiecyString: String { get }
//    var fullCargeHoursString: String { get }
...
//        super.init(brand: "", modelName: "", year: 0, doorCount: 0, weight: 0, height: 0)
//    }
//}
//
